...
supplierTable.append(`
  <tr>
    <input type="hidden" name="supplier[${childNumber-1}][supplier_id]" value="${supplier.val()}" />
    <input type="hidden" name="supplier[${childNumber-1}][uom_id]" value="${uom.val()}" />
    <input type="hidden" name="supplier[${childNumber-1}][price_per_unit]" value="${price.val()}" />
    <input type="hidden" name="supplier[${childNumber-1}][lead_time]" value="${lead_time.val()}" />
    <input type="hidden" name="supplier[${childNumber-1}][moq_id]" value="${moq.val()}" />
    <td>${childNumber}</td>
