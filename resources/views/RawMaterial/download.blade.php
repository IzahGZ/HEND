  ...
  <div id="invoice">
    <div class="invoice">
        <div style="min-width: 800px">
            ...
            <main>
                <p style="font-size:17px"><b>Raw Materials Listing</b></p>
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="text-right" style="border:1px solid black">SET UP COST (RM)</th>
                            <th class="text-right" style="border:1px solid black">INVENTORY COST (RM)</th>
                    ...
                    <tbody>
                        ...
                        <td class="no"  style="border:1px solid black">{{$loop->iteration}}</td>
                            ...
                            <td class="unit" style="border:1px solid black">{{$item->set_up_cost}}</td>
                            <td class="total" style="border:1px solid black">{{$item->inventory_cost}}</td>
