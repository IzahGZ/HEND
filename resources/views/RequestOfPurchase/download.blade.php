            ...
            <main>
                <div class="row contact">
                    ...
                    <div class="col-sm-6 invoice-details">
                        <h3 class="invoice-id">ROP{{$rop->pr_number}}</h3>
                        <div class="date">Request Date: {{$rop->request_date}}</div>
                        <div class="date">Requestor: {{$rop->request_by}}</div>
                    </div>
                </div>
                <br><br>
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="text-right" style="border:1px solid black">SUPPLIER</th>
                    ...
                    <tbody>
                        ...
                        <td class="text-left" style="border:1px solid black">{{$rop->raw_material->name}} | {{$rop->raw_material->code}}</td>
                        <td class="qty" style="border:1px solid black">{{$qty = $rop->quantity}}</td>
                        <td class="qty" style="border:1px solid black">{{$rop->raw_material_supplier->supplier->name}}</td>
                        <td class="qty" style="border:1px solid black">{{$rop->estimated_date}}</td>
                            <td class="unit" style="border:1px solid black">{{$price = $rop->raw_material_supplier->price_per_unit}}</td>
                ...
                <div class="">
                    <div class="row">
                        {{-- <div class="col" style="display:block; width:50%; margin-left:15px "> --}}
                            <div class="col" style="display:block; width:45%;  float:right ">
                                <br>
                                <br>
                                <br>
                                <br>
