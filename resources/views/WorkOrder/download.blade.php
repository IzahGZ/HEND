            ...
            <main>
                <div class="row contact">
                    <div class="col-sm-6 invoice-to">
                        ...
                        <div class="date"><h3><b>{{$workOrders->product->name}} </b></h3></div>
                        <div class="address">Total Production: {{$workOrders->quantity}} {{$workOrders->product->uoms->code}}</div>
                    </div>
                    <div class="col-sm-6 invoice-details">
                        <h3 class="invoice-id">WO{{$workOrders->work_order_no}}</h3>
                        <div class="date">Due Date: {{ date("Y-m-d", strtotime($workOrders->due_date))}}</div>
                    </div>
                </div>
                <br><br>
                <table>
                    ...
                    <tbody>
                        @foreach($workOrders->project->materials as $item)
                        <tr>
